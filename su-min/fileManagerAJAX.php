...
<table style='background-color:#E5E5E5;border:solid 1px #777777;' align='center'><tr>
	...
	<td colspan='3'>
		<table style='width:100%;'><tr>
			...
			<td style='width:20px;'><a class='optIcon' href='#' onClick='fileTree.optMkdir();return false;'><img alt='cd' title='Создать папку' src='images/createDir.png'></a></td>
			<td style='width:20px;'><a class='optIcon' href='#' onClick='fileTree.optMkfile();return false;'><img alt='cf' title='Создать файл' src='images/createFile.png'></a></td>
			<td></td>
			<td style='width:60px;text-align:center;'><img id='loadingImg' style='display:none;' src='images/load.gif'></td>
		</tr></table>
	...
	<td class='colBox'><div><table id="leftCol"  border=0 align='left'><thead><tr class='passive' onClick='fileTree.unselect();fileTree.activeCol(1);'><th>Имя</th><th>Размер</th></tr></thead><tbody><tr><td><a id='leftColUp' class='fict uplevel' href='#'>..</a></td><td></td></tr></tbody></table></div></td>
	<td></td>
	<td class='colBox'><div><table id="rightCol" border=0 align='left'><thead><tr class='passive' onClick='fileTree.unselect();fileTree.activeCol(2);'><th>Имя</th><th>Размер</th></tr></thead><tbody><tr><td><a id='rightColUp' class='fict uplevel' href='#'>..</a></td><td></td></tr></tbody></table></div></td>
</tr><tr>
	<td colspan='3'>
